...
from typing import TYPE_CHECKING, Any, AsyncGenerator, Awaitable, Callable, Coroutine, Optional, TypeVar, ParamSpec, Concatenate
...
class _AsyncTransactional(_BaseTransactional):
    ...
    def __init__(self, to_wrap: Callable[Concatenate[AsyncTransaction, P], Awaitable[T]]) -> None:
...
def async_transactional(to_wrap: Callable[Concatenate[AsyncTransaction, P], Awaitable[T]]) -> Callable[Concatenate[AsyncTransaction, P], Awaitable[T]]:
